		...
		var TableInit = function() {
			...
			oTableInit.Init = function() {
				$('#roletable').bootstrapTable({
					url : '${contextPath}/shop/queryGoodsListByCID', //请求后台的URL（*）
					method : 'POST', //请求方式（*）
					...
					columns : [{
                        ...
                        formatter:function(value,row,index){
                            var s = "<a><img style=\"width:70px;height:30px;\"  src=\""+row.coverImg+"\" /></a>";
                            return s;
                        },
                    }, {
						field : 'Button',
		...
		function operateFormatter(value, row, index) {
		      ...
		      window.operateEvents = {
		    	      ...
		    	      'click #del': function (e, value, row, index) {
		    	        	$.ajax({
		    	        		url:"${contextPath}/shop/deleGoodById",
		    	        		data:{
		    	        			id:row.id
		    	        		},
		    	        		type:"POST",
		    	        		success:function(data){
		    	        			if(data.retValue != 'success'){
		    	        				...
		    	        				alert("删除成功!");
		    	        				$("#roletable").bootstrapTable('refresh',{url:"${contextPath}/shop/queryGoodsListByCID"});
		    	        			}
