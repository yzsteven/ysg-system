					...
					<div class="ibox-content">
						<form method="get" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<div class="radio">
										<label> <input name="sex" ${user.sex == 1 ? "checked" : ""} type="radio"
											value="1">男
										</label>
									</div>
									<div class="radio">
										<label> <input name="sex" type="radio" ${user.sex == 2 ? "checked" : ""} value="2">女
										</label>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="text" id="age" name="age" value="${user.age}" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<select name="company" id="company" class="form-control m-b" value="${user.company}">
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input name="phone" id="phone" value="${user.phone}" type="text" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input name="cardid" id="cardid" type="text" value="${user.cardid}"
										class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input name="realname" id="realname" type="text" value="${user.realname}"
										class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input name="contactname" id="contactname" type="text" value="${user.contactname}"
										class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input name="contactphone" id="contactphone" type="text" value="${user.contactphone}"
										class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
