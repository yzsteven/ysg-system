...
<body class="gray-bg">
					...
					<div class="ibox-content">
						...
						<form method="get" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<select name="company" id="company" class="form-control m-b" value="${role.company}">
											<option value=""></option>
									</select>
								</div>
							</div>
	...
	<script>
        ...
        function initdefault(){
            ...
            $('#resourceIds option').each(function(i,content){
                //alert(i+"***"+content.value);
                if($.inArray($.trim(content.value),resourceId)>=0){
                    this.selected=true;
                }
            });

            //设置选中值后，需要刷新select控件
            $("#resourceIds").multiselect('refresh');
		...
		function save() {
			...
			var id = $("#id").val();
			$.ajax({
				url : "${contextPath}/role/doEditRole",
				data : {
				    id : id,
